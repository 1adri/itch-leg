    ...
    while True:
        ...
        for ev in pygame.event.get():
            ...
            if ev.type == pygame.MOUSEBUTTONDOWN:
                ...
                #if width/1.5 <= mouse[0] <= width+45 and height/1.5 <= mouse[1] <= height+10:
                    #game_width = 1920
                    #game_height = 1080
        ...
        '''
        if width/1.5 <= mouse[0] <= width+45 and height/1.5 <= mouse[1] <= height+10:
            pygame.draw.rect(screen,color_light,[width/1.5,height/1.5,140,40])
            
        else:
            pygame.draw.rect(screen,color_dark,[width/1.5,height/1.5,140,40])
        '''
        ...
        screen.blit(text, (width/2.36,height/2.27))

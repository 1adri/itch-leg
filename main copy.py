...
motion2 = False
class Basketball:
    def __init__(self, screen, running, basketball, player_x, player_y, player_facing_left, motion, background, Y_VELOCITY, Y_GRAVITY, JUMP_HEIGHT, basketball_x, basketball_y, vx, vy, def_count):
        self.screen = screen
        ...
        while self.running:
            ...
            for event in pygame.event.get():
                ...
                if event.type == pygame.KEYDOWN and event.key == pygame.K_x:
                        ...
                        motion2 = True
            basketball = Basketball(self.screen, self.running, pygame.image.load('basketball.png').convert_alpha(), self.player_x, self.player_y, self.player_facing_left,
                                    motion2, pygame.image.load('background.png').convert_alpha(), 5, 3, 2,  self.player_x+80, self.player_y+75, 5, -5,  self.def_count)
            #basketball.main()
            print(motion2)
            if motion2 == True:
                #print("ran")
